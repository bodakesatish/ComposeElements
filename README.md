...
![Standard Text Demo One](screenshots/text_demo_one.png)

-----

2. **Standard Text Two:**
   * `Text Two` (Standard Text Two)`
...
![Standard Text Demo Two](screenshots/text_demo_two.png)

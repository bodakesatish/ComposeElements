...
![Standard Text Field Demo One ](screenshots/text_field_basic_demo.png)

<img src="screenshots/text_field_demo_two.png" alt="Standard Text Field Demo Two" width="300">
-----

2. **TextFieldsWithIcon:**
   * `TextField` (TextFieldsWithIcon)`
...
```
<img src="screenshots/text_field_with_icon_demo_one.png" alt="Text Field With Icon Demo One" width="300">
<img src="screenshots/text_field_with_icon_demo_two.png" alt="Text Field With Icon Demo Two" width="300">

-----

3. **TextFieldsWithStates:**
   * `TextField` (TextFieldsWithStates)`
...
```
<img src="screenshots/text_field_states.png" alt="Text Field With Icon Demo One" width="300">

-----

4. **TextFieldsWithStates:**
   * `TextField` (TextFieldsWithStates)`
...
```
<img src="screenshots/text_field_keyboard_options_demo.png" alt="Text Field With Keyboard Options" width="300">
